        ...
        <div className="windows">
          ...
          <div className="contents">
            ...
            <div className="subtitles">
              Upload your Projects, don't forhet to add Images. You can also add
              colllect Module to monetize your content. Collect module allows
              your followers to purchase that content and mint NFTs that link to
              the publication's ContentURI. You can also leave it empty.
            </div>
